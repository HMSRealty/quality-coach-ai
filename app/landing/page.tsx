    ...
    <div style={{ background: "var(--canvas)", minHeight: "100vh", color: "var(--text-1)", overflowX: "clip" }}>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "16px 28px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <Link href="/landing" style={{ textDecoration: "none" }}><RealTrackLogo /></Link>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <a href="#features" style={navLink}>Features</a>
            <a href="#how" style={navLink}>How it works</a>
            <a href="#pricing" style={navLink}>Pricing</a>
            <Link href="/" style={navLink}>Sign in</Link>
            <Link href="/" className="btn-brand" style={{ padding: "9px 18px" }}>Get started <ArrowRight size={14} /></Link>
          </div>
        </div>
      </nav>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: 980, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          <div style={{ display: "flex", gap: 12, justifyContent: "center", marginTop: 32, flexWrap: "wrap" }}>
            <Link href="/" className="btn-brand" style={{ padding: "14px 26px", fontSize: 15 }}>Start free <ArrowRight size={16} /></Link>
          ...
          <div className="reveal" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 18, alignItems: "stretch" }}>
            {PLANS.map((p) => (
              <div key={p.name} style={{
                ...
                <Link href="/" className={p.featured ? "btn-brand" : "btn-ghost"} style={{ justifyContent: "center", padding: "12px" }}>
      ...
      <section style={{ maxWidth: 1000, margin: "0 auto", padding: "90px 28px" }}>
        <div className="reveal" style={{
          ...
          <Link href="/" className="btn-brand" style={{ marginTop: 28, padding: "14px 28px", fontSize: 15, position: "relative" }}>Get started free <ArrowRight size={16} /></Link>
        </div>
      </section>
