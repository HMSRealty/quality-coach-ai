...
import { Key, Plus, Trash2, Loader2, CheckCircle2, XCircle, Sparkles, Eye, EyeOff, AlertTriangle } from "lucide-react";
          ...
          {keys.map((k) => {
            ...
            return (
              <div key={k.id} style={{
                ...
                <button onClick={() => toggle(k)} title={k.is_active ? "Disable" : "Re-enable"}
