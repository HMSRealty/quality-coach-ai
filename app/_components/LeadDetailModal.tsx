...
export function LeadDetailModal({ leadId, onClose }: { leadId: string; onClose: () => void }) {
  ...
  return (
    <div onClick={onClose} style={{
      position: "fixed", inset: 0, background: "rgba(11,15,25,0.55)",
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        {/* Header */}
        <div style={{
          padding: "20px 24px", borderBottom: "1px solid rgba(11,15,25,0.08)",
        ...
        {loading ? (
          ...
          <div style={{ padding: 24 }}>
            ...
            {(() => {
              ...
              return (
                <div style={{
                  ...
                  border: `1px solid ${ok ? "#A7F3D0" : bad ? "rgba(11,15,25,0.10)" : "#FCD34D"}`,
            ...
            {lead.qualification_reason && (
              <div style={{ marginBottom: 20, padding: 14, borderRadius: 10, background: "#F7F8FA", border: "1px solid rgba(11,15,25,0.06)" }}>
            ...
            <div style={{
              ...
              background: flag ? `${GOLD}10` : "#F7F8FA",
              border: flag ? `1px solid ${GOLD}50` : "1px solid rgba(11,15,25,0.08)",
