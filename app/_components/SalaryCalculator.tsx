...
const INP: React.CSSProperties = {
  ...
  color: "#000", fontSize: 13, outline: "none",
};
  ...
  return (
    <div style={{ background: "#fff", border: "1px solid var(--border-2)", borderRadius: 16, padding: 20, boxShadow: "var(--shadow-sm)" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18 }}>
        ...
        <div>
          <p style={{ fontSize: 15, fontWeight: 800, color: "#000" }}>Salary Calculator</p>
      ...
      <button onClick={addKpi} style={{ display: "inline-flex", alignItems: "center", gap: 6, marginBottom: 20, padding: "7px 13px", borderRadius: 9, background: "#F8FAFC", border: "1px solid var(--border-2)", color: SKY_600, fontSize: 12.5, fontWeight: 800, cursor: "pointer" }}>
        <Plus size={13} /> Add KPI
      </button>

      {/* Results breakdown */}
      <div style={{ background: "#F8FAFC", borderRadius: 14, padding: 18, border: "1px solid var(--border-2)" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <span style={{ fontSize: 14, fontWeight: 900, color: "#000" }}>Gross Pay</span>
