  ...
  return (
    <div>
      ...
      <div style={{
        ...
        background: highlight ? "rgba(59,130,246,0.10)" : "#fff",
...
const STEPS: Step[] = [
  {
    ...
    render: () => (
      <Chrome title="RealTrack — Settings">
        ...
        <div style={{
          border: "2px dashed " + TEAL + "55", borderRadius: 12, background: "rgba(59,130,246,0.10)",
  ...
  },
  {
    ...
    render: () => (
      <Chrome title="RealTrack — Submit Lead">
        ...
        <div style={{ marginTop: 14, padding: "10px 12px", borderRadius: 9, background: "rgba(59,130,246,0.10)", border: `1px solid ${TEAL}55`, fontSize: 11, color: NAVY, fontFamily: "monospace", maxWidth: 360 }}>
