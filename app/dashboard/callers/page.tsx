    ...
    <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", flexDirection: "column", gap: 20 }} className="animate-in">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "300px 1fr", gap: 20, alignItems: "start" }}>
        ...
        <div style={{
          ...
          background: T.surface1, border: "1px solid rgba(35,43,58,0.08)", borderRadius: 14,
          overflow: "hidden", boxShadow: "0 2px 8px rgba(35,43,58,0.04)",
        }}>
          <div style={{ padding: "14px 14px 10px", borderBottom: "1px solid rgba(35,43,58,0.06)" }}>
            ...
            {filtered.map(caller => {
              ...
              return (
                <button key={caller.id}
                  ...
                  onMouseEnter={e => { if (!active) e.currentTarget.style.background = "#F2F5F9"; }}
        ...
        {selected && (
          <div className="animate-scale" style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{
              ...
              borderRadius: 14, background: `linear-gradient(135deg, ${NAVY} 0%, #2A3347 100%)`,
              color: "#fff",
            }}>
              <div style={{
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12 }}>
              {[
                ...
                <div key={label} style={{
                  background: T.surface1, border: "1px solid rgba(35,43,58,0.08)", borderRadius: 12, padding: 16,
                }}>
            ...
            <div style={{ background: T.surface1, border: "1px solid rgba(35,43,58,0.08)", borderRadius: 12, padding: 18 }}>
            ...
            <div style={{ background: T.surface1, border: "1px solid rgba(35,43,58,0.08)", borderRadius: 12, padding: 18 }}>
              ...
              {lastFeedback ? (
                <p style={{ fontSize: 13, color: NAVY, lineHeight: 1.7, padding: "12px 14px", background: T.surface3, borderRadius: 8 }}>
                  {lastFeedback}
                </p>
              ) : (
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 8 }}>
                  {topCoaching.map(([text, count], i) => (
                    <li key={i} style={{
                      ...
                      padding: "10px 12px", borderRadius: 8, background: T.surface3,
                    }}>
                      <span style={{
