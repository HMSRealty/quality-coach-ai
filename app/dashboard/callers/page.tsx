    ...
    <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", flexDirection: "column", gap: 20 }} className="animate-in">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "300px 1fr", gap: 20, alignItems: "start" }}>
        ...
        <div style={{
          ...
          background: "#FFF", border: "1px solid rgba(11,15,25,0.08)", borderRadius: 14,
          overflow: "hidden", boxShadow: "0 2px 8px rgba(11,15,25,0.04)",
        }}>
          <div style={{ padding: "14px 14px 10px", borderBottom: "1px solid rgba(11,15,25,0.06)" }}>
        ...
        {selected && (
          <div className="animate-scale" style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{
              ...
              borderRadius: 14, background: `linear-gradient(135deg, ${NAVY} 0%, #141A26 100%)`,
              color: "#fff",
            }}>
              <div style={{
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12 }}>
              {[
                ...
                <div key={label} style={{
                  background: "#FFFFFF", border: "1px solid rgba(11,15,25,0.08)", borderRadius: 12, padding: 16,
                }}>
            ...
            <div style={{ background: "#FFF", border: "1px solid rgba(11,15,25,0.08)", borderRadius: 12, padding: 18 }}>
            ...
            <div style={{ background: "#FFF", border: "1px solid rgba(11,15,25,0.08)", borderRadius: 12, padding: 18 }}>
              ...
              {lastFeedback ? (
                <p style={{ fontSize: 13, color: NAVY, lineHeight: 1.7, padding: "12px 14px", background: "#F7F8FA", borderRadius: 8 }}>
                  {lastFeedback}
                </p>
              ) : (
