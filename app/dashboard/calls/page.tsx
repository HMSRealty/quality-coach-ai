...
export default function CallsPage() {
  ...
  return (
    <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", flexDirection: "column", gap: 22 }} className="animate-in">
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <button onClick={exportCSV} style={{
            ...
            background: "#FFF", color: NAVY, border: "1px solid rgba(10,30,63,0.10)",
      ...
      <div style={{
        background: "#FFFFFF", border: "1px solid rgba(10,30,63,0.08)",
        borderRadius: 12, overflow: "hidden", boxShadow: "0 2px 8px rgba(10,30,63,0.04)",
      }}>
        {loading ? (
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              {filtered.map((lead) => {
                ...
                return (
                  <tr key={lead.id}
                    style={{ borderTop: "1px solid rgba(10,30,63,0.05)", cursor: "pointer", transition: "background 120ms" }}
                    ...
                    <td style={{ padding: "12px 16px" }}>
                      <div style={{ display: "flex", gap: 6 }}>
                        ...
                        <button onClick={(e) => { e.stopPropagation(); rerun(lead); }} disabled={rerunId === lead.id} style={{
                          padding: "5px 10px", borderRadius: 7,
                          background: "#FFF", color: NAVY, border: "1px solid rgba(10,30,63,0.08)",
